// Garage Zero Startup Teams Database
const teamsDatabase = {
    greenhotelx: {
        name: "GreenHotelX",
        category: "GreenTech",
    ...
    startupmarketing: {
        ...
        summary: "SMKS เป็นแพลตฟอร์มบริการจัดการด้านการตลาดดิจิทัล (Digital Marketing Management Service) ที่ออกแบบโครงสร้างและการทำงานขึ้นมาเพื่อตอบโจทย์กลุ่มสตาร์ทอัพโดยเฉพาะ ช่วยในการวางแผนกลยุทธ์ ค้นหาเจาะลึกพฤติกรรมลูกค้าในกลุ่มทดสอบ ตลอดจนช่วยควบคุมวิเคราะห์งบโฆษณาออนไลน์ให้เกิดผลสัมฤทธิ์อย่างสูงสุดเพื่อประหยัดเงินทุนในช่วงริเริ่มกิจการ",
